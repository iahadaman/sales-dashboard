<nav class="navbar">
    ...
    <div class="nav-item dropdown">
        ...
        <img class="rounded-circle" src="../images/profile.jpg" width="35" height="30"/><br> <span class="role-style">Admin</span>                       
        <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in">
            <a class="dropdown-item" href="#"><i class="fas fa-user fa-sm fa-fw mr-2"></i> Profile</a><a class="dropdown-item" href="#"><i class="fas fa-cogs fa-sm fa-fw mr-2"></i> Settings</a>
